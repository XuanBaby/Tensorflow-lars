    ...
    def training_step(self, batch_size):
        ...
        with tf.device('/gpu:0'):
            ...
            if FLAGS.larc_eta is not None:
                ...
                # the L2 of weights in the layers
		v_list = [tf.norm(tensor=v, ord=2) for _, v in gradvars]
		# the L2 of grads in the layers
		...
		print(v_norms.get_shape(), g_norms.get_shape())
	    ...
	    # these function will multiply the base LR, so this model just larc_param * grads 
